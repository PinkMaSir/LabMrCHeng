...
<table width="1001" height="605" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		<td colspan="6" rowspan="6"><table width="100%" height="824" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          ...
          <tr>
            <td width="248" height="412" valign="top" bgcolor="#f8f4ea"><table width="240" height="436" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="240">&nbsp;</td>
              </tr>
              <tr>
                <td align="center" valign="middle"><table width="158" height="34" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" background="../images/button.jpg"><span class="STYLE2">在线答疑</span></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
            ...
            <td width="76%" valign="top"><table width="94%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="748" align="center" valign="top"><table width="94%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="748" align="center" valign="top"><table width="100%" height="45" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                      ...
                      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
						...
						raddTime = Rs("raddTime")
						rcontent = Rs("rcontent")
						set rs = server.CreateObject("adodb.recordset")
						sql = "select * from topic where id ="&id&" and sh=1 order by addTime desc"
						rs.open sql,oConn,1,1
					%>
                              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                  <td width="11%" align="right" bgcolor="#FFFFFF" class="link3">标 题：</td>
                                  <td width="62%" align="left" bgcolor="#FFFFFF" class="link3">&nbsp;<span class="body"><%=rs("title")%></span></td>
                                ...
                                <tr>
                                  ...
                                  <td colspan="3" align="left" bgcolor="#FFFFFF" class="link3">&nbsp;<span class="body"><%=rs("content")%></td>
                                </tr>
                                <tr>
                                  <td height="38" align="right" bgcolor="#FFFFFF" class="link3"><span class="STYLE8">回复内容：</span></td>
                                  <td colspan="3" align="left" bgcolor="#FFFFFF" class="link3">&nbsp;<span class="body"><%=rs("rcontent")%></span></td>
                                </tr>
                              </table>
