		...
		<td colspan="6" rowspan="6"><table width="100%" height="824" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
            <td width="248" height="412" valign="top" bgcolor="#f8f4ea"><table width="240" height="390" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td align="center" valign="middle"><table width="158" height="34" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="158" height="34" align="center" background="../images/button.jpg"><span class="STYLE2">&nbsp;师资队伍</span></td>
                    </tr>
                </table></td>
              </tr>
			  <tr>
                <td align="left" valign="middle"><table width="100%" height="26" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="26" colspan="2"><div align="center"><a href="Teacher.asp?AnnId=1"><span class="STYLE7">队伍结构及青年教师培养</span></a></div></td>
                    </tr>
                  <tr>
                    <td width="31%" height="26">&nbsp;</td>
                    <td width="69%" height="26"><a href="Teacher.asp?AnnId=2"><span class="STYLE7">课程负责人</span></a></td>
                  </tr>
                  <tr>
                    <td height="26">&nbsp;</td>
                    <td height="26"><a href="Teacher.asp?AnnId=3"><span class="STYLE7">主讲教师</span></a></td>
                  </tr>
                  <tr>
                    <td height="26">&nbsp;</td>
                    <td height="26"><a href="Teacher.asp?AnnId=4"></a><a href="Teacher.asp?AnnId=5"><span class="STYLE7">专家简介</span></a></td>
                  </tr>
                  <tr>
                    <td height="26">&nbsp;</td>
                    <td height="26">&nbsp;</td>
              ...
              <tr>
                <td align="center" valign="middle"><table width="100%" height="286" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td height="26">&nbsp;</td>
                    <td height="26" class="STYLE7"><a href="Book.asp?AnnId=1">思考题</a></td>
                  </tr>
                  <tr>
                    <td height="26">&nbsp;</td>
                    <td height="26" class="STYLE7"><a href="course.asp?AnnId=15">试卷及参考答案</a></td>
                  </tr>
                  <tr>
                    <td height="26">&nbsp;</td>
                    <td height="26">&nbsp;</td>
            ...
            <td width="76%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="380">&nbsp;</td>
                <td height="380" colspan="2" class="link3"><%=A_Content%></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
...
<map name="Map"><area shape="rect" coords="19,14,224,80" href="http://www.xsyu.edu.cn" target="_blank">
</map></body>
</html>