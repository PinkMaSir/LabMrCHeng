...
End If
sSql="Select A_Title,A_Content,A_AddTime From Condition Where A_ID="&AnnID
...
<table width="1001" height="605" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		<td colspan="6" rowspan="6"><table width="100%" height="412" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
            <td width="248" height="412" valign="top" bgcolor="#f8f4ea"><table width="240" height="491" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td colspan="2">&nbsp;</td>
              </tr>
              <tr>
                <td colspan="2" align="center" valign="middle"><table width="158" height="34" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" background="../images/button.jpg"><a href="course.asp?AnnId=5"><span class="STYLE2">&nbsp;</span></a><span class="STYLE2">教学条件</span></td>
                    </tr>
                </table></td>
              </tr>
			  <tr>
                <td width="75" height="26" align="right" valign="middle"><a href="Book.asp?AnnId=1"><img src="../images/an.jpg" width="15" height="15" border="0"></a><a href="Condition.asp?AnnId=1"></a></td>
                <td width="165" align="left" valign="middle"><a href="Condition.asp?AnnId=1"><span class="STYLE7">教材选用与建设</span></a></td>
			  </tr>
              <tr>
                <td height="26" align="right" valign="middle" ><a href="Book.asp?AnnId=1"><img src="../images/an.jpg" width="15" height="15" border="0"></a><a href="Condition.asp?AnnId=2"></a></td>
                <td align="left" valign="middle" ><a href="Condition.asp?AnnId=2"><span class="STYLE7">实践教学条件</span></a><a href="Condition.asp?AnnId=1"></a></td>
              </tr>
			  <tr>
                <td height="26" align="right" valign="middle" ><a href="Book.asp?AnnId=1"><img src="../images/an.jpg" width="15" height="15" border="0"></a><a href="Condition.asp?AnnId=2"></a></td>
                <td align="left" valign="middle" ><a href="Condition.asp?AnnId=3"><span class="STYLE7">网络教学环境</span></a><a href="Condition.asp?AnnId=1"></a></td>
			  </tr>
              <tr>
                <td height="34" colspan="2" align="center" valign="middle"><table width="158" height="34" border="0" cellpadding="0" cellspacing="0">
                  <tr>
              ...
              <tr>
                <td colspan="2" valign="top"><table width="100%" height="286" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                ...
                <table width="100%" height="107" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center"><img src="../images/mp.JPG" width="189" height="150"></td>
                    </tr>
                  </table>
                <p>&nbsp;</p></td>
              </tr>
...
<map name="Map"><area shape="rect" coords="18,14,224,79" href="http://www.xsyu.edu.cn" target="_blank">
</map></body>
</html>