...
End If
sSql="Select A_Title,A_Content,A_AddTime From Tutor Where A_ID="&AnnID
...
<table width="1001" height="605" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		<td colspan="6" rowspan="6"><table width="100%" height="412" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
            <td width="248" height="412" valign="top" bgcolor="#f8f4ea"><table width="240" height="474" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td colspan="2">&nbsp;</td>
              </tr>
              <tr>
                <td colspan="2" align="center" valign="middle"><table width="158" height="34" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" background="../images/button.jpg"><a href="course.asp?AnnId=5"><span class="STYLE2">&nbsp;</span></a><span class="STYLE2">实验教学</span></td>
                    </tr>
                </table></td>
              </tr>
			  <tr>
                <td width="72" height="26" align="right" valign="middle"><a href="Book.asp?AnnId=1"><img src="../images/an.jpg" width="15" height="15" border="0"></a><a href="Tutor.asp?AnnId=1"></a></td>
                <td width="168" align="left" valign="middle"><a href="Tutor.asp?AnnId=1"><span class="STYLE7">实验指导书</span></a></td>
			  </tr>
              <tr>
                <td height="26" align="right" valign="middle" ><a href="Book.asp?AnnId=1"><img src="../images/an.jpg" width="15" height="15" border="0"></a><a href="Tutor.asp?AnnId=2"></a></td>
                <td align="left" valign="middle" ><a href="Tutor.asp?AnnId=2"><span class="STYLE7">虚拟实验</span></a></td>
              </tr>
              <tr>
                <td height="35" colspan="2" align="center" valign="middle"><table width="158" height="35" border="0" cellpadding="0" cellspacing="0">
                  <tr>
              ...
              <tr>
                <td colspan="2" valign="top"><table width="100%" height="286" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="center"><img src="../images/xuni.JPG" width="192" height="173"></td>
                    </tr>
                  </table>
                <p>&nbsp;</p></td>
              </tr>
...
<map name="Map"><area shape="rect" coords="17,15,225,79" href="http://www.xsyu.edu.cn" target="_blank">
</map></body>
</html>