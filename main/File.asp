...
End If
sSql="Select A_Title,A_Content,A_AddTime From File Where A_ID="&AnnID
...
<table width="1001" height="605" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		<td colspan="6" rowspan="6"><table width="100%" height="412" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
            <td width="248" height="412" valign="top" bgcolor="#f8f4ea"><table width="240" height="493" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td colspan="2">&nbsp;</td>
              </tr>
              <tr>
                <td height="34" colspan="2" align="center" valign="middle"><table width="158" height="34" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" background="../images/button.jpg"><span class="STYLE2">&nbsp;教学内容</span></td>
                    </tr>
                </table></td>
              </tr>
			  <tr>
                <td width="72" height="26" align="right" valign="middle"><a href="Book.asp?AnnId=1"><img src="../images/an.jpg" width="15" height="15" border="0"></a><a href="File.asp?AnnId=1"></a></td>
                <td width="168" align="left" valign="middle"><a href="File.asp?AnnId=1"><span class="STYLE7">理论课教学内容</span></a><a href="File.asp?AnnId=2"></a></td>
			  </tr>
              <tr>
                <td height="26" align="right" valign="middle" ><a href="Book.asp?AnnId=1"><img src="../images/an.jpg" width="15" height="15" border="0"></a><a href="File.asp?AnnId=2"></a></td>
                <td align="left" valign="middle" ><a href="File.asp?AnnId=2"><span class="STYLE7">实验课教学内容</span></a></td>
              </tr>
              <tr>
                <td height="34" colspan="2" align="center" valign="middle"><table width="158" height="34" border="0" cellpadding="0" cellspacing="0">
                  <tr>
...
<map name="Map"><area shape="rect" coords="18,14,225,80" href="http://www.xsyu.edu.cn" target="_blank">
</map></body>
</html>