...
End If
sSql="Select A_Title,A_Content,A_AddTime From Courseware Where A_ID="&AnnID
...
<table width="1001" height="605" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
	...
	<tr>
		<td colspan="6" rowspan="6"><table width="100%" height="412" border="0" cellpadding="0" cellspacing="0">
          <tr>
                ...
                <td align="center" valign="middle"><table width="158" height="34" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" background="../images/button.jpg"><table width="100%" height="34" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="27%">&nbsp;</td>
                          <td width="73%" class="STYLE2">多媒体课件</td>
                        </tr>
                      </table></td>
                    </tr>
                </table></td>
            ...
            <td width="76%" valign="top"><table  width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
              <tr>
                <td height="12" colspan="2" class="link3">&nbsp;</td>
                <td width="5%" rowspan="2">&nbsp;</td>
              </tr>
              <tr>
                <td height="13" colspan="2" class="link3">您现在的位置：<a href="default.asp">首页</a> -&gt;&gt;<a href="course.asp?AnnId=14">多媒体课件</a></td>
              </tr>
              <tr>
                <td width="5%">&nbsp;</td>
                <td width="90%"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="98%" height="30" align="center" valign="middle" class="link4 STYLE5">多媒体课件</td>
                    </tr>
                    <tr>
...
<map name="Map"><area shape="rect" coords="19,14,225,79" href="http://www.xsyu.edu.cn" target="_blank">
</map></body>
</html>